...
info: |
  ...
  Gía Kompletu pa Prinsipianti - Skola.dev
language: kea
drawings:
  persist: false
...
<div class="abs-bl m-6 text-sm text-white opacity-90">
  Skola.dev - Nôs ta studa, nôs ta kriâ, nôs ta partilha!
</div>
...
Pensa nél komu **tradutor universal**:
...
<div class="pt-8 text-sm text-skola-gray">
  Gías di setup na deskrison di vídeo!
</div>
...
<div class="pt-2 text-sm text-center text-skola-gray">
  Connection → PreparedStatement → ResultSet | Tudu trez debe sera fechadu!
</div>
...
<div class="pt-8">
  <span class="text-sm text-skola-gray">Kuatu operason baziku pa manipula dadus</span>
</div>
...
- NUN é ArrayList!
- É link vivu ku bazi
- Fecha Connection = ResultSet mori
...
<div class="pt-6 text-sm text-skola-gray">
  Dika: Le mensajen di éru ku atensaun - el ta dizé kuzé problema!
</div>
...
<div class="pt-8">
  <span class="text-skola-teal font-bold">Parabens! Bu da primeru pasu importante!</span>
</div>
