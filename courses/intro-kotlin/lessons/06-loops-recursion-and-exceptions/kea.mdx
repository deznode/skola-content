...
Un funsan **rekursivu** é un funsan ki ta txoma se própi drentu di se própi kódiku. Kada funsan rekursivu meste un **kazu bazi** (base case) — un kondisan ki ta para rekursividadi. Sen el, funsan ta kontinua txoma se própi pa senpri, te `StackOverflowError`.
