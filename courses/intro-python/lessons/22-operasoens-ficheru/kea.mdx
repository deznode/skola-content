...
Antis di abri un ficheru, bo presiza dizi pa Python **o ki bu kre faze** ku el. Es é modus prinsipais:
...
## (Opsional · avansadu) Modu `'w+'` — Skrebe i Ler (ku seek)

:::callout{type=info}
Es seksan é **opsional** — pa kumesa, trez modus `r`/`w`/`a` di riba ta txega. Volta li kuandu bo presiza ler i skrebe mesmu ficheru na un só operasan.
:::
