...
```python
# Funsan ki verifica si nùmeru é par ou ímpar
...
<KeyTakeaways>
  ...
  <RezumuItem term="Docstrings">Un string na inísiu di funsan ta dokumenta o ki el ta faze — `help(funsan)` ta mostra-l.</RezumuItem>
