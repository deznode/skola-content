...
Na vida real, nôs ta toma desizun a tudu momentu: "Si sta txobê, nha ta léba garda-txuva. Si nau, nha ta bai sin el." Programas ta funsiona mesmu maneira -- és ta presiza toma desizun baseadu na kondisaun. Na Python, nôs ta uza `if`, `elif` e `else` pa kontrola kaminhu ki programa ta sigui. Dipos di kel lisan li, bo ta sabi fazi bo programa pensa e disidi!
