...
Antis di kumesa programá, nôs precisa prepara nôs ferramentas. É manera un kuzinheru ki ta organiza ingredientis antis di kumesa fazi katchupa — bo precisa tudu na lugar sertu! Na es lisun, nôs ta instala Python, konfigura VS Code, i roda nôs priméru programa.
...
Python é grátis i disponível pa tudu sistema operasional. Bai na **[python.org/downloads](https://www.python.org/downloads/)** i fazi download di versaun más resenti (Python 3.13+).
...
Si ka ta mostra, klika na versaun di Python na barra di status i skolhi interpreter ki ta stá dentru di `.venv`.
...
**Prósimu lisun:** [Lé Errus (Tracebacks) →](/courses/intro-python/lessons/le-errus)
