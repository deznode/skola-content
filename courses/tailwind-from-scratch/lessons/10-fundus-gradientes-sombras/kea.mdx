...
I li é unde v4 ta separa kompletamente di v3. **Trez mudansas grandi ki bu meste sabe** primeru.
...
Imajen ten 4 propriedadis ki bu meste kontrola:
...
Bu pode tambén usa ángulu eksatu:
...
I bu pode kontrola **unde** kada kor para:
...
Default é pretu ku opasidadi. Bu pode kustómiza:
...
Pa fixa a skala tudu na kabesa, repete es kards te bu konxe kada sufixu di kor:
...
Es é mudansa más grandi visual te li. Si bu abri na browser, Resort Brava parsi un **produtu real**, ka mais demo di tutorial.
