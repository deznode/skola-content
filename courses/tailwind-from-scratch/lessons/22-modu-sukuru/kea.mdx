...
**Es padran = "selector-based dark mode"** — bu kontrola ku klasi.
...
:::callout{type=tip}
Adisiona kel script na `<head>` (antes di `<body>`) pa evita "flash of unstyled content" — ekran ta fika klaru por mili-segundus antes di JS ativa. Bu kre dark mode aplikadu **antes** di pajina renderiza.
:::
...
Bu kompletu Módulu 3 — **Layout i Movimentu.** Resort Brava gosi ten:
