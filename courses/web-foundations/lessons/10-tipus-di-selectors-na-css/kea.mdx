...
Imajina ki bu ten 10 paragrafu na bu pajina. Bu kre pinta **so un** di kor rosa, pa da destaki, ma kuandu bu po `p { color: pink; }`, *tudu* 10 fika rosa! Modi ki nu ta fla CSS pa toka so na *un* spesifiku? Nu meste uza armas di precisan: **classes** i **IDs**.
...
:::callout{type=tip}
Si bu skise mnemoniku **LoVe HAte**, lembra: na vida real, primeru bu ta gosta (Love = Link + Visited), dipos bu ta odia (Hate = Hover + Active). CSS ta sigi mêsmu ordi.
:::
...
<KeyTakeaways showHeader={true} chrome="inline">
  ...
  <RezumuItem term="LVHA" variant="gold">link ta sigi sempri ordi `:link`, `:visited`, `:hover`, `:active` (LoVe HAte).</RezumuItem>
