...
Antis di bu skrebe un linha di kódiku, bu ten ki ten un mental model klaru di kuze ki ta akontese kuandu bu abri un pajina di website.

<GlossaryText
  text="Kuandu bu ta dijita un [[URL]] na bu browser i primi Enter, kuatru kuza ta akontese en sekuénsia, kuazi instantáneu — un konversa kurtu entri bu browser i un [[servidor]]. Browser ta manda un [[request]], servidor ta manda di volta un [[response]], i browser ta [[parse]] kel response pa dezenha pajina. Sigi kada pasu na diagrama."
  terms={{
...
:::callout{type=tip}
Pensa na internet kumo rede di strada ki ta liga tudu komputador di mundu — fiu, sinal di rádiu, protokolu. Web é un di kez kuza ki ta viaja na es strada: pajina HTML ligadu un ku otru via link. Email i WhatsApp ta viaja na mesmu strada, ma es é ka Web.
:::

## Kada linguajen ku se responsabilidadi

Kada pajina di web ta djunta trez linguajen. Pensa na es moda trez kamada di mesmu kuza:
...
Na es kursu nu ta foka na HTML i CSS. JavaScript ta ben dispós, na un kursu separadu (`intro-javascript`).
